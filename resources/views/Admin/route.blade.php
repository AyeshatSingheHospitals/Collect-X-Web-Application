...
<main>
    ...
    <div class="col-12 mt-5 center-align-container">
        <!-- Display the image -->
        <img src="{{ asset('../image/Map Animated.gif') }}" alt="No Records" class="img-fluid mb-3"
        ...
        <div class="col-md-4">
            <div class="card mb-3 custom-card">
                <div class="card-body">
                    ...
                    <p class="card-text"><strong>Lab Name:</strong><span class="{{ optional($route->lab)->name ? '' : 'lab-not-assigned' }}">{{ optional($route->lab)->name ?? 'Lab not Defined' }}</span></p>
        ...
        <div class="popup-content">
            ...
            <form action="{{ route('admin.routes.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="labSearch" name="labSearch" class="form-control rounded-pill"
                        placeholder="Type to search labs..." required>
        ...
        @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="description" class="form-control rounded-pill"
                        placeholder="Enter your description" value="N/A" />
                </div>
...
// Function to filter and reposition Route cards by name and lab name
function filterLabs() {
    ...
    cards.forEach((card) => {
        ...
        const labNameElement = card.querySelector(".card-text span"); // Get lab name element

        const labName = labNameElement ? labNameElement.textContent.toLowerCase() : "";

        if (routeName.includes(searchValue) || labName.includes(searchValue)) {
