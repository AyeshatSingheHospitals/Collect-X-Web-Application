            ...
            <table class="transactions-table">
                ...
                <tbody id="transactions-table-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="edit-btn" style="font-size:1.2rem;" data-id="{{ $transaction['tid'] }}" data-amount="{{ $transaction['amount'] }}"><i class='bx bxs-pen' ></i></button>
                        </td>
                    </tr>
                    @endforeach
                    @else
...
<style>
    ...
    .transactions-table th {
        ...
        position: sticky;
        top: 0; /* This keeps the header at the top of the table */
        z-index: 1; /* Ensures the header stays on top of the table body */
    }
