...
<main>
    ...
    <div class="status">
        <div class="info">
            <h3>Today's Sales ({{ \Carbon\Carbon::today()->format('Y-m-d') }})</h3>
            <h1>Rs.{{ number_format($todaySales, 2) }}</h1>
        </div>
        <div class="progresss">
            <svg>
        ...
        <div class="visits">
            <div class="status">
                <div class="info">
                    <h3>Total Routes</h3>
                    <h1>{{ number_format($routeCount) }}</h1>
                </div>
                <div class="progresss">
                    <svg>
                        <circle cx="38" cy="38" r="36"></circle>
        ...
        <div class="centers">
            <div class="status">
                <div class="info">
                    <h3>Total Centers</h3>
                    <h1>{{ number_format($centerCount) }}</h1>
                </div>
                <div class="progresss">
                    <svg>
                        <circle cx="38" cy="38" r="36"></circle>
        ...
        <div class="labassigns">
            <div class="status">
                <div class="info">
                    ...
                    <h1>{{ number_format($labassignCount) }}</h1>
                </div>
                <div class="progresss">
                    <svg>
                        <circle cx="38" cy="38" r="36"></circle>
        ...
        <div class="ros">
            <div class="status">
                <div class="info">
                    ...
                    <h1>{{ number_format($supervisorCount) }}</h1>
                </div>
                <div class="progresss">
                    <svg>
                        <circle cx="38" cy="38" r="36"></circle>
        ...
        <div class="supervisors">
            <div class="status">
                <div class="info">
                    ...
                    <h1>{{ number_format($inchargeCount) }}</h1>
                </div>
                <div class="progresss">
                    <svg>
                        <circle cx="38" cy="38" r="36"></circle>
